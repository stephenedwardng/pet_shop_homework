...
class TestPetShop < Minitest::Test
  ...
  def test_pet_shop_name # precede method 'name' w 'test_'
    # pass hash 'pet_shop' to method 'pet_shop_name' & assign to 'name'
    name = pet_shop_name(@pet_shop) 
    # boolean compare expected and actual from variable 'name'
